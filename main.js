...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ciccio-𝐁𝐨𝐭', 'Safari', '2.0.0'] : methodCodeQR ? ['ciccio-𝐁𝐨𝐭', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `ciccio-𝐁𝐨𝐭 𝐨𝐧𝐥𝐢𝐧𝐞 𝐝𝐚 ${uptime} `
